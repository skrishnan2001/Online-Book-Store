...
<html lang="en-US">
    <head>
        <title>31 Years' Chapterwise Solutions CBSE AIPMT and NEET - Physics,Chemistry,Biology</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='31 Years Chapterwise Solutions CBSE AIPMT and NEET - Physics,Chemistry,Biology' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9789313160403") or die (mysqli_error);
