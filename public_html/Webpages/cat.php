...
<html lang="en-US">
    <head>
        <title>How to Prepare for Quantitative Aptitude for the CAT</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='How to Prepare for Quantitative Aptitude for the CAT' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9789353160180") or die (mysqli_error);
