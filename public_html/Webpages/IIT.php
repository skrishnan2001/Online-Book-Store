...
<html lang="en-US">
    <head>
        <title>Chapter-Topicwise Solved Papers (2019-1979) IIT-JEE (JEE Mains & Advanced)</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='Chapter-Topicwise Solved Papers (2019-1979) IIT-JEE (JEE Mains & Advanced)' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9789350949085") or die (mysqli_error);
