...
<html lang="en-US">
    <head>
        <title>Harry Potter : The Deathly Hallows</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='Harry Potter : The Deathly Hallows' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9780605039070") or die (mysqli_error);
