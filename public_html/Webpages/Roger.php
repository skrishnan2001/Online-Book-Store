...
<html lang="en-US">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='The Murder of Roger Ackroyd' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9780792754367") or die (mysqli_error);
