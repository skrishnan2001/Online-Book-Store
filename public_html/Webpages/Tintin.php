...
<html lang="en-US">
    <head>
        <title>Tintin : Explorers on the Moon</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='Tintin : Explorers on the Moon' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9782203031401") or die (mysqli_error);
