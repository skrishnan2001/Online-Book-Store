...
<html lang="en-US">
    <head>
        <title> The Trials of Apollo : The Tyrant's Tomb</title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='The Trials of Apollo : The Tyrants Tomb' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9788418038525") or die (mysqli_error);
