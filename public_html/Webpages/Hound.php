...
<html lang="en-US">
    <head>
        <title>The Hound Of Baskerville </title>
        <meta charset="UTF-8">
    ...
    <?php
        ...
        $re=mysqli_query($conn,"SELECT Name,Price,COUNT(*) as qty from cart  where Name='The Hound of Baskervilles' group by Name" )or die (mysqli_error($conn)) ;
        $re1=mysqli_query($conn,"SELECT Name,Stock,Price from mybooks where ISBN=9781523800414") or die (mysqli_error);
